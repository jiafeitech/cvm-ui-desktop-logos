...
%package httpd
Summary:	Cvm UI Desktop related icons and pictures used by httpd
...
cp -a cvm-ui-desktop/*.svg $RPM_BUILD_ROOT%{_datadir}/%{name}
...
%changelog
* Mon Dec 19 2022 Podter <me@podter.xyz> - 37.0.0-1
